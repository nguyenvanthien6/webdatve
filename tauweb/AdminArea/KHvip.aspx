<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="KHvip.aspx.cs" Inherits="KHvip" Title="Tau: Create Agent" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <table align="center" style="text-align:center">
        <tr>       
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Thông tin khách hàng" Font-Size= "X-Large"  
    ...
    <table border="0" align="left" style="text-align:left">
        ...
        <tr>
            <td align="right">
                <asp:Label ID="lblfname" runat="server" AssociatedControlID="txtfname">Họ</asp:Label>
            </td>
            <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblshopname" runat="server" AssociatedControlID="txtshopname">Tên chức vụ</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblshopadd" runat="server" AssociatedControlID="txtshopadd">Địa chỉ</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblcity" runat="server" AssociatedControlID="txtcity">Thành phố</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblph" runat="server" AssociatedControlID="txtph">Số điện thoại</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblmobile" runat="server" AssociatedControlID="txtmobile">Số điện thoại 2</asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lbldeposit" runat="server" AssociatedControlID="txtdeposit">Tiền đặt cọc</asp:Label>
                </td>
                <td>
                  ...
                  <asp:RangeValidator ID="rangeamount" ControlToValidate ="txtdeposit" Text="Không hợp lệ" Type ="Double"  MinimumValue="100" MaximumValue="1000000" runat="server" />
                  </td>  
            ...
            <tr><td></td>
                <td>
                    <asp:Button ID="btnfinish" Text="Hoàn thành" runat="server" 
