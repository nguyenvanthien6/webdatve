<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreateKH.aspx.cs" Inherits="CreateKH" Title="Tau: Create KH" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <table align="center" style="text-align:center">
        <tr>       
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Đăng ký" Font-Size= "X-Large"  
        ...
        LoginCreatedUser="False"  oncreatinguser="CreateUserWizard1_CreatingUser" BorderStyle="None" OnCreatedUser="CreateUserWizard1_CreatedUser" 
       >
        <WizardSteps>
                        ...
                        <tbody>
                            <tr>
                                <td align="center" colspan="2" style="padding-bottom:15px">
                                    <strong> Bạn hãy nhập thông tin</strong></td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Label ID="QuestionLabel" runat="server" AssociatedControlID="Question">Câu hỏi bảo mật:</asp:Label></td>
                                <td>
                            ...
                            <tr>
                                <td align="right">
                                    <asp:Label ID="AnswerLabel" runat="server" AssociatedControlID="Answer">Trả lời:</asp:Label></td>
                                <td>
