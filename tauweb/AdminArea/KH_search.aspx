<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="KH_search.aspx.cs" Inherits="AdminArea_Agent_search" Title="Tau:Search Agent" %>
                               ...
                               <tr><td colspan="4">&nbsp;</td></tr>
                                ...
                                <tr>
                                    <td align="center" colspan="4">
                                        <asp:Button ID="btnsubmit" runat="server" OnClick="btnsubmit_Click" Text="Tìm" />
                                    </td>
                                </tr>
                        ...
                        <table width="285px" border="0">
                            ...
                            <tr>
                                <td colspan="3" align="center" style="padding-top:15px">
                                    <asp:Button ID="btnsub" Text="Gửi" runat="server" OnClick="btnsub_Click" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
