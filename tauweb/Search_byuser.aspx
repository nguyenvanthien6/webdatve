<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Search_byuser.aspx.cs" Inherits="Search_user" Title="Tau:Search Tickets" %>
    ...
    <table align="center">
        <tr align="left">
            <td align="left" class="style1" >
               <strong> <asp:Label ID="lblheat" runat="server" Text="Tìm vé" Font-Size= "X-Large"  
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>
                                                    ...
                                                    <td >
                                                        ...
                                                        <asp:Button ID="btnshow" runat="server" Text ="Hiển thị" onclick="btndisplay_Click1" />    
                                                        </td>
                                                </tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tbody>
                                        <tr>
                                            <td class="logo">
                                                <!-- logo here-->
                                                <img alt="bus" src="Images/Capture.PNG" />
                                                <!-- end of logo-->
                                            </td>
                                        </tr>
                                    </tbody>
