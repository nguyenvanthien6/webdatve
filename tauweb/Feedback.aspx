<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Feedback.aspx.cs" Inherits="Feedbackajax" Title="Tau: Feedback" %>
     ...
     <div id="innertitle">
        <table align="center" style="margin-bottom:25px">
            <tr align="left">
                <td align="left" >
                    <strong>
                        <asp:Label ID="lblheat" runat="server" Text="Phản hồi" Font-Size="X-Large" ForeColor="#F7990D"></asp:Label></strong>
                    <br />
                </td>
            </tr>
        </table>
            ...
            <div id="formBody" style="margin:0 auto;text-align:center">
                <table cellspacing="3" cellpadding="0" border="0" align="center" style="text-align:left">
                    <tbody>
                        ...
                        <tr>
                            <td height="30">
                                <strong><span>Số điện thoại:</span></strong>
                            </td>
                            <td valign="middle">
                            ...
                            <td valign="middle">
                                <div id="txtHint">
                                    <asp:DropDownList CssClass="form" tyle="width: 130px" ID="dlsubject" runat="server"
                                        Width="133px">
                                        <asp:ListItem Text="Dich vu tau" Value="Dich vu tau"></asp:ListItem>
                                        <asp:ListItem Text="website" Value="website"></asp:ListItem>
                                        <asp:ListItem Text="Hanh trinh" Value="Hanh trinh"></asp:ListItem>
                        ...
                        <tr>
                            <td> 
                                <strong><span style="vertical-align:middle">Bình luận:</span></strong><br />(Tối đa 100 ký tự)
                            </td>
                            <td class="style1">
