<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="~/Secret/selectseat.aspx.cs" Inherits="starselectseet2" Title="Tau:Book Tickets Now" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content1" runat="Server">
    <table align="center">
        <tr>       
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Đặt vé ngay!" Font-Size= "X-Large"  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="63%" align="left" height="27">
                                                            <asp:DropDownList CssClass="form" ID="Source" runat="server">
                                                                <asp:ListItem Text="SaiGon" Value="SaiGon"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                ...
                                                                <ContentTemplate>
                                                                    <div id="txtHint">
                                                                        <asp:DropDownList CssClass="form" tyle="width: 130px" ID="Destination" runat="server" 
                                                                            ...
                                                                            <asp:ListItem Text="PhuQuoc" Value="PhuQuoc"></asp:ListItem>
                                                                            <asp:ListItem Text="ConDao" Value="ConDao"></asp:ListItem>
