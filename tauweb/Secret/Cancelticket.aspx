<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Cancelticket.aspx.cs" Inherits="Secret_Cancelticket" Title="Tau" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <table align="center">
        <tr>
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Hủy vé" Font-Size= "X-Large"  
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>
                                                    ...
                                                    <td >
                                                        ...
                                                        <asp:Button ID="btnshow" runat="server" Text ="Hiển thị" onclick="btnshow_Click1" />    
                                                        </td>
                                                </tr>
                                                    ...
                                                    <table cellspacing="2" cellpadding="2" border="0" style="border:2px solid gray;padding:15px; ">
                                                        <tbody  align="left"  >
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:Button ID="btndel" runat="server" Text ="Xóa vé" onclick="btndel_Click" />
                                                                </td></tr>
