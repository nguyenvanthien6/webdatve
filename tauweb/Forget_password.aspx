<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Forget_password.aspx.cs" Inherits="Forget_password" Title="Tau: Recover Password" %>
                                ...
                                <table border="0" cellpadding="2">
                                    ...
                                    <tr>
                                        <td align="center" colspan="2">
                                            Nhập tên bạn để lấy lại mật khẩu.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="right" colspan="2">
                                            <asp:Button ID="btnque" runat="server" Text="Tiếp tục" onclick="btnque_Click"  />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td>
                                <table border="0" cellpadding="2">
                                    ...
                                    <tr>
                                        <td align="right">
                                            <asp:Label ID="lblans" runat="server" AssociatedControlID="txtans">Trả lời:</asp:Label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="right" colspan="2">
                                         <asp:Button ID="btnsubmit" runat="server" Text="Tiếp tục" onclick="btnsubmit_Click"/>
                                ...
                                <table border="0" cellpadding="2">
                                    ...
                                    <tr>
                                        <td align="right" colspan="3">
                                              <asp:Button ID="btnnext" runat="server" Text="Gửi" onclick="btnnext_Click" />
