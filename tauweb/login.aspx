<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="login" Title="Tau: Log In" %>
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="LoginButton" runat="server" BackColor="#FFFBFF" 
                                        ...
                                        Font-Names="Verdana" Font-Size="1em" ForeColor="#284775" Text="Đăng nhập" 
                            ...
                            <tr>
                                <td colspan="2" style="text-align:left">
                                    <asp:HyperLink ID="PasswordRecoveryLink" runat="server" 
                                        NavigateUrl="~/Forget_password.aspx">Quên mật khẩu</asp:HyperLink>
                                </td>
                            </tr>
                        </table>
                    </td>
